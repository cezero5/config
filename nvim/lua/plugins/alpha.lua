-- ~/.config/nvim/lua/alpha.lua

return {
  "goolord/alpha-nvim",  -- Nombre del plugin
  ...
  config = function()
    ...
    -- Función para obtener la longitud de los caracteres (UTF-8)
    ...
    local alpha_c = function()
        ...
        dashboard.section.buttons.val = {
            dashboard.button("<C-e>", "  New file", "<Cmd>ene <CR>"),
            dashboard.button("<C-f>", "  Find file", "<Cmd>Telescope find_files<CR>"),
            dashboard.button("<C-s>", "  Neobin config", "<Cmd>Neotree reveal ~/.config/nvim<CR>"),
            dashboard.button("<C-q>", "  Quit", "<Cmd>qa<CR>"),
        }
